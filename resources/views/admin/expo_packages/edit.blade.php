...
-------------------------->
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <form role="form" method="post" action="{{ url('admin/expo-package/'.$package->id) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <img id="inputImage" onclick="$('#pic').trigger('click');"
                                ...
                                src="{{$package->pic==''?"/img/no-image.png":$package->pic}}" class="img-rounded"
