...
<div class="col-xs-12">
  <div class="box">
    ...
    <div class="box-header">
      ...
      <a href="{{url('admin\expo-package\create')}}" class="btn btn-primary pull-right" style="margin-left: 1em;"><i class="fa fa-plus"></i> {{ __('words.NewPackage') }}</a>
    </div>
    <!-- /.box-header -->
    ...
    <div class="box-body table-responsive no-padding">
      ...
      <table class="table table-hover persian-table table-striped table-bordered">
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-warning" href="{{action('Admin\ExpoPackageController@edit', $package['id'])}}">
              <i class="fa fa-edit" title="{{ __('words.ChangePackage') }}"></i> {{ __('words.ChangePackage') }}
            </a>
            <form style="display:inline;" action="{{ url('admin/expo-package/' . $package->id) }}" method="post"
