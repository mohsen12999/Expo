...
@section('title', __('words.AnswerTicket'))
...
<div class="col-xs-12">
  ...
  <div class="box direct-chat direct-chat-warning">
    ...
    <div class="box-footer">
      <form role="form" method="post"  action="{{ url('admin/answer-ticket/'.$ticket->id) }}" enctype="multipart/form-data">
        @csrf
      ...
      <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> {{ __('words.SendAnswer') }}</button>
      </form>
    </div>
    <!-- /.box-footer -->
  </div>
