                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <img id="inputImage" onclick="$('#pic').trigger('click');"
                                style="cursor: pointer;width: auto;height: 180px;"
                                src="{{$booth->pic==''?"/img/no-image.png":$booth->pic}}" class="img-rounded"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control"
                            placeholder="description ...">{{$booth->description}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="package_id" name="package_id" class="form-control">
                            ...
                            <option value="{{$package->id}}" @if($booth->package_id==$package->id ) selected @endif
                    ...
                    <div class="form-group">
                        ...
                        <select id="package_id" name="package_id" class="form-control">
                            ...
                            <option value="{{$expo->id}}" @if($booth->expo_id==$expo->id ) selected @endif
                                >{{$expo->title}}</option>
                            @endforeach
                            @endif
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="theme_id" name="theme_id" class="form-control">
                            ...
                            <option value="{{$theme->id}}" @if($booth->theme_id==$theme->id ) selected @endif
                                >{{$theme->title}}</option>
                            @endforeach
                            @endif
                        </select>
                    ...
                    <div class="form-group">
                        <label for="videos" class="control-label">{{ __('words.NewVideo') }}</label>
                        <input id="videos" name="videos[]" type="file" multiple accept="video/*"
                            class="form-control-file" />
                        <span for="videos" class="text-danger"></span>
                    </div>
