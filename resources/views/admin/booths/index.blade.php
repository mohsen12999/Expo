...
<section class="content container-fluid">
  ...
  <div class="col-md-12">
    <div class="box box-primary">
      ...
      <div class="box-header with-border">
        ...
        <a href="{{url('admin\booth\create')}}" class="btn btn-primary pull-right" style="margin-left: 1em;"><i
            class="fa fa-plus"></i> {{ __('words.NewBooth') }}</a>
      </div>

      @if(count($booths) === 0)
      <div class="no-data">
        <h3>{{ __('words.NoBoothsMessage') }}</h3>
        <a href="{{url('admin\booth\create')}}" class="btn btn-primary" style="margin-left: 1em;"><i
            class="fa fa-plus"></i> {{ __('words.NewBooth') }}</a>
      </div>
      @else
  ...
  <div class="no-data">
    <a href="{{url('admin\booth\create')}}" class="btn btn-primary" style="margin-left: 1em;"><i class="fa fa-plus"></i>
      new Booth</a>
  </div>
