...
<div class="col-xs-12">
  <div class="box">
    ...
    <div class="box-header">
      ...
      <a href="{{url('admin/user-expo-package/buy-package')}}" class="btn btn-primary pull-right" style="margin-left: 1em;"><i class="fa fa-plus"></i> {{ __('words.BuyPackage') }}</a>
    </div>
    <!-- /.box-header -->
    ...
    <div class="box-body table-responsive no-padding">
      ...
      @if (count($userPackages) === 0)
        <div class="no-data">
          ...
          <a href="{{url('admin/user-expo-package/buy-package')}}" class="btn btn-primary" style="margin-left: 1em;"><i class="fa fa-plus"></i> {{ __('words.BuyPackage') }}</a>
        </div>
      @else
