...
@section('title', __('words.NewComment'))
...
<div class="col-xs-12">
  <div class="box box-primary">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">{{ __('words.NewComment') }}</h3>
    </div>

    <form role="form" method="post"  action="{{ url('admin/comment/') }}" enctype="multipart/form-data">
      @csrf
