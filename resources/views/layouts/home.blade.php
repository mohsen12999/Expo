          ...
          <div class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownLang">
                <a class="dropdown-item" href="{{ url('setlocale/en') }}">{{ __('words.English') }}</a>
                <a class="dropdown-item" href="{{ url('setlocale/fa') }}">{{ __('words.Persian') }}</a>
                <a class="dropdown-item" href="{{ url('setlocale/ru') }}">{{ __('words.Russian') }}</a>
                <a class="dropdown-item" href="{{ url('setlocale/ar') }}">{{ __('words.Armenian') }}</a>
              </div>
            </li>
    ...
    <footer>
        <section id="footer" class="text-center">
            <div class="container">
                ...
                <p>Enjoy a full day with Gravitas Beauty Expo designed for beauty brandfounders to connect, vend and be supported by beauty lovers, buyers,influencers and press. </p>
