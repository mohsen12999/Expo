...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('css/adminlte/font-awesome.min.css') }}" />
    <!-- Ionicons -->
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{url('/home')}}" class="logo">
                ...
                <span class="logo-mini"><b>Expo</b></span>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="@if (App::isLocale('fa')) pull-right @else pull-left @endif image">
                        <img src="{{ asset(Auth::user()->avatar_or_default())}}" class="img-circle" alt="profile pic" />
                    </div>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="@if($menu=='expo') active @endif">
                        <a href="{{url('admin\expo')}}"><i class="fa fa-image"></i>
                            <span>{{ __('words.Expos') }}</span></a>
                    </li>
                    <li class="@if($menu=='categories') active @endif">
                        <a href="{{url('admin\category')}}"><i class="fa fa-list"></i>
                            <span>{{ __('words.CategoriesItem') }}</span></a>
                    </li>
                    <li class="@if($menu=='expo_categories') active @endif">
                        <a href="{{url('admin\expo-category')}}"><i class="fa fa-list"></i>
                            <span>{{ __('words.ExposItem') }}</span></a>
                    </li>
                    <li class="@if($menu=='packages') active @endif">
                        <a href="{{url('admin\package')}}"><i class="fa fa-shopping-cart"></i>
                            <span>{{ __('words.CatgoryPackages') }}</span></a>
                    </li>
                    <li class="@if($menu=='expo_packages') active @endif">
                        <a href="{{url('admin\expo-package')}}"><i class="fa fa-shopping-cart"></i>
                            <span>{{ __('words.ExpoPackages') }}</span></a>
                    </li>
                    <li class="@if($menu=='users') active @endif">
                        <a href="{{url('admin\users')}}"><i class="fa fa-user"></i>
                            <span>{{ __('words.Users') }}</span></a>
                    </li>
                    <li class="@if($menu=='invoices') active @endif">
                        <a href="{{url('admin\invoices')}}"><i class="fa fa-money"></i>
                            <span>{{ __('words.Invoices') }}</span></a>
                    </li>

                    <li class="@if($menu=='sliders') active @endif">
                        <a href="{{url('admin\slider')}}"><i class="fa fa-object-group"></i>
                            <span>{{ __('words.sliders') }}</span></a>
                    </li>
                    <li class="@if($menu=='posts') active @endif">
                        <a href="{{url('admin\post')}}"><i class="fa fa-newspaper-o"></i>
                            <span>{{ __('words.posts') }}</span></a>
                    </li>
                    <li class="@if($menu=='pages') active @endif">
                        <a href="{{url('admin\page')}}"><i class="fa fa-window-restore"></i>
                            <span>{{ __('words.pages') }}</span></a>
                    </li>
                    <li class="@if($menu=='comments') active @endif">
                        <a href="{{url('admin\comment')}}"><i class="fa fa-users"></i>
                            <span>{{ __('words.comments') }}</span></a>
                    </li>
                    <li class="@if($menu=='brands') active @endif">
                        <a href="{{url('admin\brand')}}"><i class="fa fa-tags"></i>
                            <span>{{ __('words.brands') }}</span></a>
                    </li>
                    <li class="@if($menu=='counter') active @endif">
                        <a href="{{url('admin\counter')}}"><i class="fa fa-clock-o"></i>
                            <span>{{ __('words.counter') }}</span></a>
                    </li>
                    <li class="@if($menu=='setting') active @endif">
                        <a href="{{url('admin\setting')}}"><i class="fa fa-cogs"></i>
                            <span>{{ __('words.setting') }}</span></a>
                    </li>
                    ...
                    <li class="@if($menu=='my_expo_package') active @endif">
                        <a href="{{url('admin\user-expo-package')}}">
                            <i class="fa fa-shopping-cart"></i> <span>{{ __('words.MyBoothPackage') }}</span>
                        </a>
                    </li>
